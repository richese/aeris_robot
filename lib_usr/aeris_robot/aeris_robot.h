...
/* Aeris surface sensors I2C definitions */
/* I2C switch reset pin */
...
#define AERIS_RGB_SS_FRONT_RIGHT_CENTER ((u32)2)
#define AERIS_RGB_SS_FRONT_RIGHT        ((u32)3)
#define AERIS_RGB_SS_REAR_LEFT          ((u32)4)
#define AERIS_RGB_SS_REAR_LEFT_CENTER   ((u32)5)
#define AERIS_RGB_SS_REAR_RIGHT_CENTER  ((u32)6)
#define AERIS_RGB_SS_REAR_RIGHT         ((u32)7)
